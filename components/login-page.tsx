    ...
    <div className="flex-1 flex items-center justify-center p-6 bg-gray-50">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign in to your Wordwise account to continue</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Button variant="link" onClick={onSwitchToSignup} className="p-0 h-auto font-semibold" disabled={isLoading}>
              Sign up
            </Button>
          </div>
        </CardContent>
